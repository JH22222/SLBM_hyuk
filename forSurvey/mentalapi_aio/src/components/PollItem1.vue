...
<template>
  <div v-if=item.poll_key class="card text-center mb-5"
    ...
    <div class="card-footer text-muted">
      <div v-for="(selection, idx) in meta.selections" class="form-check form-check-inline btn btn-group btn-outline-dark px-3" @click="clickBtn(meta.value[idx], item.poll_key)">
